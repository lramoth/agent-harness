...
Calls to external providers and external services are not needed while
implementing logic. Real calls happen only during evaluation, in a separate
session, when the evaluation scenario requires genuine external service
confirmation.
